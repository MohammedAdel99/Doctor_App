...
class TextStyles {
  ...
  static TextStyle font14BlueSemiBold =
      const TextStyle(fontSize: 14, color: ColorsManager.mainBlue, fontWeight: FontWeightHelper.semiBold);      
  static TextStyle font15DarkBlueMedium =
      const TextStyle(fontSize: 15, color: ColorsManager.darkBlue, fontWeight: FontWeightHelper.medium);                    
